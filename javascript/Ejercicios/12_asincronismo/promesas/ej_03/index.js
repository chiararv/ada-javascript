...
const listaAlumnas = (alum, cursos) => {
  return alum.map((alumna) => {
...
fetchAlumnas()
  ...
  .then( (data) => {
    cursos = data
    console.log( listaAlumnas(alumnas, cursos) )
  })




// const cursos = fetchCursos().then(CURSOS)

// const alumnas = fetchAlumnas().then(ALUMNAS)

// listaAlumnas(alumnas, cursos)
